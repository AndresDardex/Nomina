...
public class ControladorVolumenCaja implements ActionListener{ 
    
    Formulario objetoVista;
    Nomina objetoModelo;
    public ControladorVolumenCaja(){
        ...
        if(e.getSource()==objetoVista.getBotonnomina())
    {
      ...
      objetoVista.getListasalarios().getSelectedItem().toString()));
        ...
        objetoVista.getTxtnomina().append("Nombre Empleado:" + objetoModelo.getNombre()+"\n");
